package com.demo.sociss_datepicker_timepicker;
...
public class MainActivity extends Activity {
    ...
    public void getFormWidgets()
    {
        ...
        editCv=(EditText) findViewById(R.id.edit_cong_viec);
        editNd=(EditText) findViewById(R.id.edit_noi_dung);
        btnDate=(Button) findViewById(R.id.btn_date);
        btnTime=(Button) findViewById(R.id.btn_time);
        btnAdd=(Button) findViewById(R.id.btn_them_con_viec);
        lvCv=(ListView) findViewById(R.id.lv_cong_viec);
